...
import 'colors.dart';
class textDesigns{
  static const TextStyle  basicPanelText = TextStyle(color:AppColors.defaultText,fontSize: 20,fontWeight: FontWeight.w300 );
  static const TextStyle  resizePanelText = TextStyle(color:Color.fromRGBO(26, 28, 35, 1),fontSize: 22,fontWeight: FontWeight.w800 );
