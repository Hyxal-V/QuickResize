        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                decoration: textfieldStyle(hintText: "Width"),
                style: TextStyle(color: AppColors.defaultText),
                keyboardType: TextInputType.number,
                  ...
                  setState(() {
                    if (newSelection.last == 'Original') {
                      heightController.text =
                          '${stateProvider.img.originalHeight}';
                      widthController.text =
                          '${stateProvider.img.originalWidth}';
                      stateProvider.img.targetHeight =
                          stateProvider.img.originalHeight;
                      stateProvider.img.targetWidth =
                          stateProvider.img.originalWidth;
                    }
